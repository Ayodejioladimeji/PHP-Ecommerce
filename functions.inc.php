...
function get_product($con,$limit='',$cat_id='',$product_id='',$search_str='',$sort_order='',$is_best_seller='',$sub_categories='',$type=''){
...
function sentInvoice($con,$order_id){
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="layobright11@gmail.com";
	$mail->Password="basiratu";
	$mail->SetFrom("layobright11@gmail.com");
