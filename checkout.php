        ...
        <div class="checkout-wrap ptb--100">
            <div class="container">
                <div class="row">
                        ...
                        <div class="checkout__inner">
                            <div class="accordion-list">
                                <div class="accordion">
									...
									?>
									<div class="accordion__title" style="background:#151c58;color:white;">
                                        Checkout Method
                                    </div>
                                        ...
                                        <div class="accordion__body__form">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="checkout-method__login">
                                                        <form id="login-form" method="post">
                                                            <h5 class="checkout-method__title" style="color:#151c58;font-weight:bolder">Login</h5>
                                                            ...
                                                            <p class="require">* Please Login to continue</p>
                                                            <div class="dark-btn">
                                                                <button style="background:orangered" type="button" class="fv-btn" onclick="user_login()">Login</button>
                                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="checkout-method__login">
                                                        <form action="#">
                                                            <h5 class="checkout-method__title" style="color:#151c58;font-weight:bolder">Register</h5>
                                                            <div class="single-input">
                                                            ...
                                                            <div class="dark-btn">
                                                                <button style="background:orangered" type="button" class="fv-btn" onclick="user_register()">Register</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
									...
									<?php } ?>
                                    <div style="background:#151c58;color:white;" class="<?php echo $accordion_class?>">
                                        Address Information
                                    </div>
									<form method="post">
										<div class="accordion__body">
										...
										<div class="accordion__body">
											<div class="paymentinfo">
												<div class="single-method" style="color:#151c58;font-family:cursive;font-weight:bold;">
													Order and Pay Later <input type="radio" name="payment_type" value="COD" required/><br>
													Make payment Now <input type="radio" name="payment_type" value="payu" required/>
												</div>
										 ...
										 <input style="background:orangered" type="submit" name="submit" class="fv-btn"/>
									</form>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="order-details" style="background:#151c58">
                            <h5 style="background:orangered;color:white;" class="order-details__title">Your Order</h5>
                            <div class="order-details__item">
								...
								<div class="single-item">
                                    ...
                                    <div class="single-item__content">
                                        <a style="color:white;font-family:cursive" href="#"><?php echo $pname?></a>
                                        <span style="color:white" class="price">₦<?php echo $price*$qty?></span>
                                    </div>
							...
							<div class="ordre-details__total" id="coupon_box">
                                <h5 style="color:white">Coupon Value</h5>
                                <span style="color:white" class="price" id="coupon_price">₦</span>
                            </div>
                            <div class="ordre-details__total">
                                <h5 style="color:white">Order total</h5>
                                <span style="color:white;font-size:18px" class="price" id="order_total_price">₦<?php echo $cart_total?></span>
                            </div>
							
							<div class="ordre-details__total bilinfo">
                                <input type="textbox" id="coupon_str" class="coupon_style mr5"/> 
								<input style="background:orangered" type="button" name="submit" class="fv-btn coupon_style" value="Apply Coupon" onclick="set_coupon()"/>
